...
public class MainAplikasi extends javax.swing.JFrame {
    ...
    public void tampilKeJTable()
    {
        try {
            ...
            for(Mahasiswa m : this.mhsController.ambilSemuaData())
            {
    ...
    private void initComponents() {
        ...
        cbJurusan.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "TI", "SI", "TK", "KA" }));
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addComponent(cbJurusan, javax.swing.GroupLayout.PREFERRED_SIZE, 75, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
       ...
       try {
            ...
            ms.setNim (txtNIM.getText());
            ms.setNama (txtNama.getText());
            ms.setJurusan (cbJurusan.getSelectedItem().toString());
            mhsController.simpanData(ms);
            tampilKeJTable();
            txtNIM.setText("");
            txtNama.setText("");
            cbJurusan.setSelectedIndex(0);
        } catch (SQLException ex) {
            Logger.getLogger(MainAplikasi.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            MainAplikasi apl = new MainAplikasi();
            apl.setTitle("Belajar Swing");
            apl.setVisible(true);
        });
    }
